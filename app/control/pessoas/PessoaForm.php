...
class PessoaForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle('Criar Fornecedor');
        ...
        $grupo_id = new TDBUniqueSearch('grupo_id', 'erphouse', 'Grupo_Ativo', 'id', 'nome');
        ...
        $cpf->setMinLength(11);
        $codigo_nacional->setMinLength(14);
        ...
        $this->form->addFields( [ new TLabel('Razão Social') ], [ $nome ], [ new TLabel('Nome Fantasia') ], [ $nome_fantasia ] );
        //$this->form->addFields( );    
        $this->form->addFields( [ new TLabel('CNPJ') ], [ $codigo_nacional ], [ new TLabel('CPF') ], [ $cpf ] );
        $this->form->addFields( [ new TLabel('Tipo de Pessoa') ], [ $tipo ], [ new TLabel('Perfil') ], [ $grupo_id ]);
        $this->form->addFields( [ new TLabel('Insc.Estadual') ], [ $codigo_estadual ], [ new TLabel('Insc.Municipal') ], [ $codigo_municipal ] );
        ...
        $codigo_nacional->setMask('99.999.999/9999-99', true);
        $codigo_nacional->addValidation('CNPJ', new TMaxLengthValidator, array(18));

        $cpf->setSize('100%');
        $cpf->setMask('999.999.999-99', true);
        $cpf->addValidation('CPF', new TMaxLengthValidator, array(14));

        $codigo_estadual->setSize('100%');
        $codigo_municipal->setSize('100%');

        $fone->setSize('100%');
        $fone->setMask('(99) 99999-9999', true);
        $fone->addValidation('Fone', new TMaxLengthValidator, array(15));
        ...
        $nome->addValidation('Razão Social', new TRequiredValidator);
        $nome_fantasia->addValidation('Nome Fantasia', new TRequiredValidator);
        $tipo->addValidation('Tipo', new TRequiredValidator);
        $codigo_nacional->addValidation('CNPJ', new TRequiredValidator);
