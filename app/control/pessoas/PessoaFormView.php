...
class PessoaFormView extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        //Botoões de ação
        $this->form->addHeaderActionLink( 'Editar', new TAction(['PessoaForm', 'onEdit'],['key'=>$param['key']]), 'far:edit blue');
        $this->form->addHeaderActionLink( 'Imprimir', new TAction([$this, 'onPrint'], ['key'=>$param['key'], 'static' => '1']), 'far:file-pdf red');
        $this->form->addHeaderActionLink( 'Gerar etiqueta', new TAction([$this, 'onGeraEtiqueta'], ['key'=>$param['key'], 'static' => '1']), 'far:envelope purple');
