...
class SystemUserList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->html = new THtmlRenderer('app/resources/titulo_usuario.html');
    
        $replaces = [];
        $replaces['title']  = 'Usuários';
        $replaces['botao'] = 'Criar Usuário';
        ...
        $column_telefone->enableAutoHide(500);        
        ...
        $this->datagrid->enableSearch($input_search, 'id, name, login, email, telefone, active');
