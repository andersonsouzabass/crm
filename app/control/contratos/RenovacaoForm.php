 ...
 */
class RenovacaoForm extends TPage
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        */
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_RenovaContrato');
        $this->form->setFormTitle('Renovação de Contrato');
        ...
        TRadioGroup::disableField('form_RenovaContrato', 'gera_viagem');
        ...
        TButton::disableField('form_RenovaContrato', 'botaendereco');
        ...
        //Botoões do form
        $this->form->addHeaderActionLink( _t('Close'),  new TAction(array('RenovacaoList','onReload')),  'fa:times red' );
        $btn = $this->form->addAction(_t('Save'), new TAction([$this, 'onSave'], ['static'=>'1']), 'fa:save');
        $btn->class = 'btn btn-sm btn-primary';
        $this->form->addActionLink('Limpar',  new TAction([$this, 'onClear']), 'fa:eraser red');
        $this->form->addActionLink('Cancelar', new TAction(array('RenovacaoList','onReload')),  'fa:times red' );
    ...
    public function onDetailAdd( $param )
    {
        try
        {
            ...
            TForm::sendData( 'form_RenovaContrato', $data, false, false );

            TRadioGroup::enableField('form_RenovaContrato', 'gera_viagem'); //Libera o botão para que possa ser adicionado um endereço
            TButton::enableField('form_RenovaContrato', 'botaendereco');
    ...
    public static function onDetailEdit( $param )
    {
        ...
        TDBCombo::reloadFromModel('form_RenovaContrato', 'detail_produto', 'erphouse', 'Produto', 'id', 'produto', null, $criteria, TRUE);
    ...
    public function onSave($param)
    {
        try
        {
            ...
            TForm::sendData('form_RenovaContrato', (object) ['id' => $master->id]);

            TRadioGroup::enableField('form_RenovaContrato', 'gera_viagem'); //Libera o botão para que possa ser adicionado um endereço
            TButton::enableField('form_RenovaContrato', 'botaendereco');
            
            new TMessage('info', 'Renovação de Contrato registrada com sucesso!');
        }
        catch (Exception $e) // in case of exception
        {
            new TMessage('error', $e->getMessage());
    ...
    public static function onGeraViagem($param)
    {
        ...
        {
            TCombo::enableField('form_RenovaContrato', 'endereco_contrato_id');
        ...
        {
            TCombo::disableField('form_RenovaContrato', 'endereco_contrato_id');
    ...
    public static function onListaProduto($param)
    {
        try
        {
            ...
            {
                TDBCombo::clearField('form_RenovaContrato', 'detail_produto');
            }
    ...
    public function AdicionarEndereco($param)
    {
        ...
        TSession::setValue('form_RenovaContrato',$data);   
    ...
    public static function ListaEnderecos($param)
    {
        try
        {
            ...
            if (!empty($param))
            {
                ...
                // formname, field, database, model, key, value, ordercolumn = NULL, criteria = NULL, startEmpty = FALSE
                TDBCombo::reloadFromModel('form_RenovaContrato', 'endereco_contrato_id', 'erphouse', 'EnderecoContrato', 'id', 'tipo', null, $criteria, TRUE);
            }
            else
            {
                TDBCombo::clearField('form_RenovaContrato', 'endereco_contrato_id');
            }
