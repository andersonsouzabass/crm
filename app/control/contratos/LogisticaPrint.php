 ...
 */
class LogisticaPrint extends TPage
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        */
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_LogisticaPrint');
        $this->form->setFormTitle('Logística - Impressão de Guia de Coleta');
        ...
        TRadioGroup::disableField('form_LogisticaPrint', 'gera_viagem');
        ...
        TButton::disableField('form_LogisticaPrint', 'botaendereco');
        ...
        $row = $this->form->addFields(  [ new TLabel('Pagamento'), $forma_pagamento ],
        ...
        //Botoões do form
        $this->form->addHeaderActionLink( _t('Close'),  new TAction(array('LogisticaList','onReload')),  'fa:times red' );

        $gerar_encaminhamento = new TAction(array($this, 'onGenerate'));
        
        $btn = $this->form->addAction('Gerar Guia', $gerar_encaminhamento, 'far:check-circle green');
        $btn->class = 'btn btn-sm btn-primary';


        $this->form->addActionLink('Limpar',  new TAction([$this, 'onClear']), 'fa:eraser red');
        $this->form->addActionLink('Cancelar', new TAction(array('LogisticaList','onReload')),  'fa:times red' );
    ...
    public function onDetailAdd( $param )
    {
        try
        {
            ...
            TForm::sendData( 'form_LogisticaPrint', $data, false, false );

            TRadioGroup::enableField('form_LogisticaPrint', 'gera_viagem'); //Libera o botão para que possa ser adicionado um endereço
            TButton::enableField('form_LogisticaPrint', 'botaendereco');
    ...
    public static function onDetailEdit( $param )
    {
        ...
        TDBCombo::reloadFromModel('form_LogisticaPrint', 'detail_produto', 'erphouse', 'Produto', 'id', 'produto', null, $criteria, TRUE);
        ...
        try
        {
            ...
            if (isset($param['key']))
            {
                ...
                */
                ...
                $criteria = TCriteria::create( ['pessoa_id' => $object->fornecedor_id] );
    ...
    public function onSave($param)
    {
        try
        {
            ...
            TForm::sendData('form_LogisticaPrint', (object) ['id' => $master->id]);

            TRadioGroup::enableField('form_LogisticaPrint', 'gera_viagem'); //Libera o botão para que possa ser adicionado um endereço
            TButton::enableField('form_LogisticaPrint', 'botaendereco');
            
            new TMessage('info', 'Guia Gerada com Sucesso!');
        }
        catch (Exception $e) // in case of exception
        {
            new TMessage('error', $e->getMessage());
    ...
    public static function onGeraViagem($param)
    {
        ...
        {
            TCombo::enableField('form_LogisticaPrint', 'endereco_contrato_id');
        ...
        {
            TCombo::disableField('form_LogisticaPrint', 'endereco_contrato_id');
    ...
    public static function onListaProduto($param)
    {
        try
        {
            ...
            {
                $criteria = TCriteria::create( ['pessoa_id' => $param['fornecedor_id'] ] );
            ...
            {
                TDBCombo::clearField('form_LogisticaPrint', 'detail_produto');
            }
    ...
    public function AdicionarEndereco($param)
    {
        ...
        TSession::setValue('form_LogisticaPrint',$data);   
    ...
    public static function ListaEnderecos($param)
    {
        try
        {
            ...
            if (!empty($param))
            {
                ...
                // formname, field, database, model, key, value, ordercolumn = NULL, criteria = NULL, startEmpty = FALSE
                TDBCombo::reloadFromModel('form_LogisticaPrint', 'endereco_contrato_id', 'erphouse', 'EnderecoContrato', 'id', 'tipo', null, $criteria, TRUE);
            }
            else
            {
                TDBCombo::clearField('form_LogisticaPrint', 'endereco_contrato_id');
            }
