 ...
 *
 */
class RenovacaoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $criteria->add(new TFilter('status', '=', 'Aguardando Contato') );
        ...
        $replaces = [];
        $replaces['title']  = 'Renovação de Contratos';
        ...
        */
        ...
        $action1 = new TDataGridAction(['RenovacaoForm', 'onEdit'], ['id'=>'{id}']);
