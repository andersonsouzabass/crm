<?php
/**
 * Lista de contratos para a tela de renovação
 *
 */
class LogisticaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $criteria->add(new TFilter('gera_viagem', '=', 'sim') );
        $this->setCriteria($criteria); 

        // create the HTML Renderer
        $this->html = new THtmlRenderer('app/resources/operacao/titulo_renovacao.html');

        $replaces = [];
        $replaces['title']  = 'Logística - Impressão de Guia de Coleta';
        ...
        */
        ...
        $action1 = new TDataGridAction(['LogisticaPrint', 'onEdit'], ['id'=>'{id}']);
